...
namespace Archer.Animations
{
    ...
    public class AnimationController : MonoBehaviour
    {
        ...
        public Vector3 Diskard(Vector3 startPosition, Vector3 endPosition, float deltaTime)
        {
            ...
            Vector3 nextPos = Vector3.Lerp(startPosition, endPosition, normilizeTime) +
                              (new Vector3(0, _discardOffsetY, 0) * _discardCurve.Evaluate(normilizeTime));
        ...
        public Vector3 TakenPosition(Vector3 startPosition, Vector3 endPostion, float deltaTime)
        {
            ...
            Vector3 nextPos = Vector3.Lerp(startPosition, endPostion, normilizeTime) +
                              (new Vector3(0, _takenPositionOffsetY, 0) * _takenPositionCurve.Evaluate(normilizeTime));
        ...
        private void PlayeCurrentAnimation(string animationName, float animationSpeed, string nextAnimationName,
