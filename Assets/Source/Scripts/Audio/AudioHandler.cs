...
namespace Archer.Audio
{
    ...
    {
        private AudioDataConfig _audioDataConfig;
        ...
        public void Init(AudioSource sfxAudioSource, AudioSource musicAudioSource, AudioDataConfig audioDataConfig)
        {
            Instance = this;
        ...
        public void Play(Sounds sound)
        {
            ...
            AudioItem audio = _audioDataConfig.AudioItems.FirstOrDefault(a => a.Sound == sound);
